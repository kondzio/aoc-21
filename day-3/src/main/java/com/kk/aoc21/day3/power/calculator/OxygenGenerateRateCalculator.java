...
public class OxygenGenerateRateCalculator implements MetricCalculator {
    @Override
    public Metric calculate(@NonNull DecodedReport decodedReport) {
        ...
        return new Metric(MetricUtils.toBinaryString(decodedReport.getBinaryReport()[selectedIndex]));
    }

    private Set<Integer> selectIndexes(DecodedReport decodedReport, String dominantMetric, Set<Integer> indexes, int dominantIdx) {
